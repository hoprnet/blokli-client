            ...
            test-integration-curvy = {
              ...
              program = toString (
                pkgs.writeShellScript "test-integration-curvy" ''
                  export BLOKLI_TEST_REMOTE_IMAGE="europe-west3-docker.pkg.dev/hoprassociation/docker-images/bloklid-anvil-curvy:0.14.1-commit.3c8c744@sha256:8425a10279ea096199cb4bdcfba674a5c9def33474b49e7c0df676a4377e9698"
